...
public class ClientRunner {
    ...
    private final IClientBase clientExample;
    private final boolean serverRequired;

    public ClientRunner(IClientBase clientExample) throws Exception {
        // this(clientExample, true);
        this(clientExample, false);
    }

    public ClientRunner(IClientBase clientExample, boolean serverRequired) throws Exception {
